...
<div>
	...
	<div class="news-preview" :style='{"width":"100%","margin":"0 auto","position":"relative","background":"url(http://codegen.caihongy.cn/20230202/738791e5d58a4645a4ee25591f67fcca.jpg) no-repeat left top / 600px auto,url(http://codegen.caihongy.cn/20230202/8ab48bc29535492eb17dd1756fd6f963.jpg) no-repeat right bottom / 600px auto"}'>
				<!-- 样式三 -->
		<div class="list3 index-pv1" :style='{"width":"100%","padding":"0 7%","height":"auto"}'>
			<div :style='{"width":"100%","padding":"0 0 0 120px","margin":"0 0 20px","position":"relative","background":"#f6f6f6","height":"100px"}' v-for="item in newsList" :key="item.id" @click="toNewsDetail(item)" class="list-item animation-box">
				<div :style='{"padding":"10px 0 0","whiteSpace":"nowrap","overflow":"hidden","color":"#333","lineHeight":"1","fontSize":"16px","textOverflow":"ellipsis"}' class="title ">{{item.title}}</div>
				<div :style='{"padding":"0 20px 0 0","margin":"5px auto 0","overflow":"hidden","color":"#555","lineHeight":"30px","fontSize":"14px","textIndent":"2em","height":"60px"}' class="introduction ">{{item.introduction}}</div>
        <div
            :style='{
    "color": "#fff",
    "top": "0",
