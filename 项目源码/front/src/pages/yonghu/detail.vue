		...
		<div class="attr" :style='{"padding":"0","overflow":"hidden","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
			...
			<div class="info" :style='{"width":"86%","padding":"20px 0","margin":"0 7% ","minWidth":"500px","background":"none","flex":"1"}'>
				...
				<div class="item" :style='{"border":"0 double #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 4px","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>账号</div>
					<div  :style='{"width":"100%","padding":"4px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.zhanghao}}</div>
				</div>
				<div class="item" :style='{"border":"0 double #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 4px","display":"flex"}'>
					...
					<div  :style='{"width":"100%","padding":"4px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.xingming}}</div>
				</div>
				<div class="item" :style='{"border":"0 double #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 4px","display":"flex"}'>
					...
					<div  :style='{"width":"100%","padding":"4px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.xingbie}}</div>
				</div>
				<div class="item" :style='{"border":"0 double #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 4px","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>邮箱</div>
					<div  :style='{"width":"100%","padding":"4px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.youxiang}}</div>
				</div>
				<div class="item" :style='{"border":"0 double #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 4px","display":"flex"}'>
					...
					<div  :style='{"width":"100%","padding":"4px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.shoujihaoma}}</div>
				</div>
