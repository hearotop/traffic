		...
		<div class="attr" :style='{"padding":"0","overflow":"hidden","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
			...
			<div class="info" :style='{"width":"86%","padding":"20px 0","margin":"0 7% ","minWidth":"500px","background":"none","flex":"1"}'>
				...
				<div class="item" :style='{"border":"0 double #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 4px","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>线路编号</div>
					<div  :style='{"width":"100%","padding":"4px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.xianlubianhao}}</div>
				</div>
				<div class="item" :style='{"border":"0 double #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 4px","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>票价</div>
					<div  :style='{"width":"100%","padding":"4px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.piaojia}}</div>
				</div>
				<div class="item" :style='{"border":"0 double #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 4px","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>班次</div>
					<div  :style='{"width":"100%","padding":"4px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.banci}}</div>
				</div>
				<div class="item" :style='{"border":"0 double #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 4px","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>发车间隔</div>
					<div  :style='{"width":"100%","padding":"4px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.fachejiange}}</div>
				</div>
				<div class="item" :style='{"border":"0 double #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 4px","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>起始点</div>
					<div  :style='{"width":"100%","padding":"4px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.qishidian}}</div>
				</div>
				<div class="item" :style='{"border":"0 double #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 4px","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>途径地</div>
					<div  :style='{"width":"100%","padding":"4px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.tujingdi}}</div>
				</div>
				<div class="item" :style='{"border":"0 double #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 4px","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>终止点</div>
					<div  :style='{"width":"100%","padding":"4px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.zhongzhidian}}</div>
				</div>
				<div class="item" :style='{"border":"0 double #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 4px","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>车辆名称</div>
					<div  :style='{"width":"100%","padding":"4px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.cheliangmingcheng}}</div>
				</div>
				<div class="item" :style='{"border":"0 double #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 4px","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>车牌号</div>
					<div  :style='{"width":"100%","padding":"4px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.chepaihao}}</div>
				</div>
				<div class="item" :style='{"border":"0 double #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 4px","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>更新时间</div>
					<div  :style='{"width":"100%","padding":"4px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.gengxinshijian}}</div>
				</div>
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"0","background":"#f50000","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="isAuth('gongjiaoluxian','维护')" @click="onAcross('xianluweihu','','','')" type="warning">维护</el-button>
				</div>
			</div>
  ...
  export default {
    ...
    methods: {
      ...
      onAcross(acrossTable,crossOptAudit,statusColumnName,tips,statusColumnValue){
        localStorage.setItem('crossTable',`gongjiaoluxian`);
      ...
      storeup(type) {
        ...
        if (type == -1 && this.isStoreup) {
          this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 1, refid: this.detail.id, tablename: 'gongjiaoluxian', userid: localStorage.getItem('userid')}}).then(res => {
