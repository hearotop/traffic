...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"30px 7%","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"center","height":"auto"}'>
      ...
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>站点地址</div>
        <el-input v-model="formSearch.zhandiandizhi" placeholder="站点地址" clearable></el-input>
      </el-form-item>
	  ...
	  <el-button v-if="isAuth('zhandianxinxi','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 10px","margin":"0 4px 0 0","color":"#fff","minWidth":"90px","outline":"none","borderRadius":"0","background":"#f50000","width":"auto","fontSize":"14px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/zhandianxinxiAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="list" :style='{"width":"calc(93% - 200px)","padding":"20px 7%","margin":"20px 0 10px","minWidth":"900px","background":"none","flex":"1"}'>
		...
		<div class="list2 index-pv1" :style='{"padding":"0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
			<div :style='{"padding":"10px","margin":"0 0 20px","flexWrap":"wrap","background":"none","display":"flex","width":"49%","fontSize":"0","position":"relative","justifyContent":"space-between","height":"240px"}' v-for="(item, index) in dataList" :key="index" @click="toDetail(item)" class="list-item animation-box">
				<img :style='{"width":"48%","padding":"4px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230201/e692aea55f98482aaa7f0290e1888901.png) no-repeat center top / 100% 100%","display":"inline-block","height":"100%"}' v-if="item.zhandiantupian && item.zhandiantupian.substr(0,4)=='http'" :src="item.zhandiantupian" class="image" />
				<img :style='{"width":"48%","padding":"4px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230201/e692aea55f98482aaa7f0290e1888901.png) no-repeat center top / 100% 100%","display":"inline-block","height":"100%"}' v-else :src="baseUrl + (item.zhandiantupian?item.zhandiantupian.split(',')[0]:'')" class="image" />
				<div class="item-info" :style='{"width":"48%","padding":"10px","overflow":"hidden","display":"inline-block","height":"100%"}'>
					<div :style='{"border":"0 dashed #eee","margin":"0 0 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","textAlign":"center","background":"linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(238,238,238,1) 50%, rgba(255,255,255,1) 100%)","borderWidth":"1px 0","lineHeight":"40px","fontSize":"14px","textOverflow":"ellipsis"}' class="name ">{{item.zhandianmingcheng}}</div>
					<div :style='{"border":"0 dashed #eee","margin":"0 0 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","textAlign":"center","background":"linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(238,238,238,1) 50%, rgba(255,255,255,1) 100%)","borderWidth":"1px 0","lineHeight":"40px","fontSize":"14px","textOverflow":"ellipsis"}' class="name ">{{item.zhandiandizhi}}</div>
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        if (this.formSearch.zhandiandizhi != '') searchWhere.zhandiandizhi = '%' + this.formSearch.zhandiandizhi + '%';
