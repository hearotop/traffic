		...
		<div class="attr" :style='{"padding":"0","overflow":"hidden","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
			...
			<div class="info" :style='{"width":"86%","padding":"20px 0","margin":"0 7% ","minWidth":"500px","background":"none","flex":"1"}'>
				...
				<div class="item" :style='{"border":"0 double #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 4px","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>车辆编号</div>
					<div  :style='{"width":"100%","padding":"4px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.cheliangbianhao}}</div>
				</div>
				<div class="item" :style='{"border":"0 double #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 4px","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>车辆类型</div>
					<div  :style='{"width":"100%","padding":"4px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.cheliangleixing}}</div>
				</div>
				<div class="item" :style='{"border":"0 double #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 4px","display":"flex"}'>
				...
				<div class="item" :style='{"border":"0 double #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 4px","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>车辆颜色</div>
					<div  :style='{"width":"100%","padding":"4px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.cheliangyanse}}</div>
				</div>
				<div class="item" :style='{"border":"0 double #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 4px","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>司机</div>
					<div  :style='{"width":"100%","padding":"4px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.siji}}</div>
				</div>
				<div class="item" :style='{"border":"0 double #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 4px","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>座位数</div>
					<div  :style='{"width":"100%","padding":"4px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.zuoweishu}}</div>
				</div>
				<div class="item" :style='{"border":"0 double #eee","padding":"0","margin":"0 0 10px 0","background":"none","borderWidth":"0 0 4px","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>出厂日期</div>
					<div  :style='{"width":"100%","padding":"4px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.chuchangriqi}}</div>
				</div>
  ...
  export default {
    ...
    methods: {
      ...
      storeup(type) {
        ...
        if (type == -1 && this.isStoreup) {
          this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 1, refid: this.detail.id, tablename: 'gongjiaochexinxi', userid: localStorage.getItem('userid')}}).then(res => {
