	...
	methods: {
		...
		styleChange() {
			this.$nextTick(() => {
				  ...
				  const icon = {"border":"none","padding":"0 0 16px","margin":"0 20px","borderRadius":"0px","background":"none","display":"none","width":"calc(100% - 40px)"}
	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo>.el-menu-item {
				  				  ...
				  				  color: #333;
				  				  white-space: nowrap;
				  				  background: url(http://codegen.caihongy.cn/20221207/20c96724e10a45b1b9484273b3008758.png) no-repeat,#fff;
				  				  line-height: 59px;
				  				  position: relative;
				  		}
