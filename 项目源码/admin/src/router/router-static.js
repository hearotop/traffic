...
import center from '@/views/center'
    ...
    import xianluweihu from '@/views/modules/xianluweihu/list'
    import gongjiaochexinxi from '@/views/modules/gongjiaochexinxi/list'
...
const routes = [{
	...
	path: '/xianluweihu',
        name: '线路维护',
        component: xianluweihu
      }
      ,{
	path: '/gongjiaochexinxi',
        name: '公交车信息',
        component: gongjiaochexinxi
      }
      ,{
	path: '/gongjiaoluxian',
        name: '公交路线',
