<template>
	<div class="addEdit-block" :style='{"padding":"30px"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="站点名称" prop="zhandianmingcheng">
					<el-input v-model="ruleForm.zhandianmingcheng" placeholder="站点名称" clearable  :readonly="ro.zhandianmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="站点名称" prop="zhandianmingcheng">
					<el-input v-model="ruleForm.zhandianmingcheng" placeholder="站点名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.zhandiantupian" label="站点图片" prop="zhandiantupian">
					<file-upload
						tip="点击上传站点图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.zhandiantupian" label="站点图片" prop="zhandiantupian">
					...
					<img v-else class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zhandiantupian.split(',')" :src="$base.url+item" width="100" height="100">
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="站点地址" prop="zhandiandizhi">
					<el-input v-model="ruleForm.zhandiandizhi" placeholder="站点地址" clearable  :readonly="ro.zhandiandizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="站点地址" prop="zhandiandizhi">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="途径车辆" prop="tujingcheliang">
					<el-input
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.tujingcheliang" label="途径车辆" prop="tujingcheliang">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.tujingcheliang}}</span>
				</el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='zhandiantupian'){
							this.ruleForm.zhandiantupian = obj[o];
	...
	if(this.ruleForm.zhandiantupian!=null) {
		this.ruleForm.zhandiantupian = this.ruleForm.zhandiantupian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    zhandiantupianUploadChange(fileUrls) {
	    this.ruleForm.zhandiantupian = fileUrls;
    },
  }
};
</script>
