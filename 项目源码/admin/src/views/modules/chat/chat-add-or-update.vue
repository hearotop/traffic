  ...
  <div :style='{"padding":"30px"}'>
    ...
    >
      ...
      <el-form-item :style='{"padding":"0","margin":"0"}'>
        <el-button :style='{"border":"0px solid #5e9808","cursor":"pointer","padding":"0 30px","margin":"0 20px 0 0","outline":"none","color":"#333","borderRadius":"4px","background":"url(http://codegen.caihongy.cn/20221207/a9d275fd8e5f4ababbf9129cc1d20492.png) no-repeat center top / 100% 100%,rgba(255,255,255,.8)","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="primary" @click="onSubmit">回复</el-button>
        <el-button :style='{"border":"1px solid #ccc","cursor":"pointer","padding":"0 30px","margin":"0","outline":"none","color":"#333","borderRadius":"4px","background":"url(http://codegen.caihongy.cn/20221207/a9d275fd8e5f4ababbf9129cc1d20492.png) no-repeat center top / 100% 100%,rgba(255,255,255,.8)","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' @click="back()">返回</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
