<template>
	<div>
		<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://gamerdp.hearone.top:9000/anzhuo/back.jpg)","display":"flex","width":"100%","backgroundSize":"100% auto","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
			<el-form v-if="pageFlag=='register'" :style='{"width":"600px","padding":"40px 20px 20px","margin":"0","borderRadius":"10px","background":"rgba(255,255,255,.3)","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"width":"100%","margin":"0 0 10px 0","lineHeight":"44px","fontSize":"28px","color":"#333","textAlign":"center"}' class="title">城市交通管理系统的设计与实现注册</div>
				...
				<button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"5px auto 5px","outline":"none","color":"#fff","borderRadius":"0px","background":"#d26248","display":"block","width":"80%","fontSize":"16px","height":"36px"}' type="button" class="r-btn" @click="login()">注册</button>
